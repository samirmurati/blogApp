...
app.get("/", function (req, res) {
  Post.find({}, function (err, foundPost) {
    if (!err) {
      res.render("home", { home_text: homeStartingContent, posts: foundPost });
    }
  });
});
...
app.get("/posts/:postName", function (req, res) {
  const requiredParam = req.params.postName;
  Post.findOne({ title: requiredParam }, function (err, foundPost) {
    if (!err) {
      res.render("post", {
        postsTitle: foundPost.title,
